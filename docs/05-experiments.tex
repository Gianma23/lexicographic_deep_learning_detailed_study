...
and AHD are omitted as summaries of quantities already shown, and per-level
accuracies enter through \cref{fig:baseline_readout_level}, where they answer a
specific question. TICE is quoted only under independent decoding, because
