...
\emph{protocol adaptation} applies the common rules of
\cref{ssec:fidelity_protocol} without changing the
...
run. All the runs therefore use the same data. The same three training
...
deviation to be reported, but they are not enough for a significance test. Thus, no
...
orthonormal frame and a level regulariser (\cref{ssec:design_substrate}). The
