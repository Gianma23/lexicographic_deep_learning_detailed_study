...
from ..common.config import section_to_dict
...
def build_model(cfg: Any, num_classes_per_level: List[int], taxonomy: Optional[Dict] = None):
    ...
    return HRNModel(
        ...
        wide_depth=int(cfg.model.get("wide_depth", 28)),
        wide_widen_factor=int(cfg.model.get("wide_widen_factor", 8)),
        wide_drop_rate=float(cfg.model.get("wide_drop_rate", 0.0)),
        ...
        projection_cfg=section_to_dict(cfg.model.get("projection", None)),
        taxonomy=taxonomy,
